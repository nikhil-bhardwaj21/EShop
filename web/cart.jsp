                    ...
                    <table class="table table-condensed">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="cart_total">
                                    <p class="cart_total_price"><%=rs.getString("rate")%></p>
                                </td>
                                <td class="cart_delete">
                                    <a class="cart_quantity_delete" href="cartitemremove.jsp?serialno=<%=rs.getString("serialno")%>&cart=cart"><i class="fa fa-times"></i></a>
                                </td>
                            </tr>
                        </tbody>
                        <%}
